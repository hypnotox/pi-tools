...
1. **Timing** records agent, turn, and tool durations and carries timing continuity into a handoff. Timing entries use the host's default transcript spacing for upstream portability.
