...
4. For compaction, inspect the native terminal error text. Cancellation, insufficient history, and failures do not auto-retry. Pi 0.85.1 omits custom focus from split-turn prefix summarization; see [Guided compaction](../README.md#guided-compaction).
