...
- Terminal assurance settlement: the package integration suite now saves, clears, and restores `PI_TOOLS_SUBAGENT_CHILD`, so its explicit parent-registration contract passes under both ordinary and child-marked test runners.
